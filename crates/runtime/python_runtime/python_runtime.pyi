...
class OutputReceiverWrapper:
    async def changed(self) -> None: ...
    def has_changed(self) -> bool: ...
    def get(self) -> tuple[float, CoreOutputWrapper]: ...
    def get_and_update(self) -> tuple[float, CoreOutputWrapper]: ...
    def clone(self) -> OutputReceiverWrapper: ...


class InputSenderWrapper:
    async def send(self, control: ControlWrapper | None): ...
